"use client"
import { HrtlLine, Button } from "@components"
  ...
  return (
    <div>
      ...
      <HrtlLine/>
        ...
        <input className='form__input' disabled={submitting} placeholder='Title here' value={paste.title} onChange={(e) => setPaste({...paste,title:e.target.value})}/>
        <textarea rows={15} className='form__input' disabled={submitting} value={paste.paste} placeholder='Enter text here...' onChange={(e) => setPaste({...paste,paste:e.target.value})}/>
