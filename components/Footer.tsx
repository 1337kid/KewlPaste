  ...
  return (
    <div>
      ...
      Made with <FontAwesomeIcon icon={faHeart} style={{color:'rgb(139 92 246)'}} size="lg"/> by&nbsp;
        ...
        Source Code : <a href="https://github.com/1337kid/KewlPaste"><FontAwesomeIcon icon={faGithub} size="lg" className="text-violet-500 hover:text-violet-600 cursor-pointer"/></a>
      </p>
    </div>
  )
}
